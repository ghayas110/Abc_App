      ...
      <View
        ...
        <View>
          ...
          <View>
            ...
            <View style={{flexDirection: 'row', paddingVertical: 15}}></View>
            <View
              style={{
                display: 'flex',
                flexDirection: 'row',
              ...
              <View>
                <Text
                  style={{fontWeight: 'bold', fontSize: 17, color: 'black',paddingLeft:10}}>
                  Residential address
                </Text>
                <Text style={styles.text2}>Street: 55, Tawi Marsousah Street</Text>
              </View>
            </View>
