  ...
  return (
    <>
      <TouchableOpacity
        ...
        <Image
          source={require('../../assets/CreateAccoutImages/back.png')}
          ...
          <View>
            ...
            <View>
              ...
              <View style={styles.acordions}>
                ...
                <Text style={styles.text2}>Razak Bin Osman</Text>
              </View>
              <View>
                <Text
                  style={{
              ...
              <View style={{display: 'flex', flexDirection: 'row'}}>
                <Image
                  source={require('../../assets/SignUp/visa.png')}
                  style={{
              ...
              <View style={{flexDirection: 'row', paddingVertical: 15}}>
                <View>
                  ...
                  <Text style={styles.text2}>
                  Street: 55, Tawi Marsousah Street
                  </Text>
                </View>
              </View>
            </View>
                ...
                <View
                  ...
                  <View style={{paddingTop: 45}}>
                    <Text
                      ...
                      You have successfully placed your card order
                    </Text>
                    <Text style={styles.text2}>
                      Your card will reach to your doorstep within next 7
                      working days{' '}
                    </Text>
                  </View>
                </View>
