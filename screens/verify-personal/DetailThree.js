        ...
        <>
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <CheckBoxInput textStyle={{...style.black_color_h, fontSize: 17, marginLeft: 10 }} text={"Daily spending"} color={"#00a200"} />
                    <CheckBoxInput textStyle={{...style.black_color_h, fontSize: 17, marginLeft: 10 }} text={"Saving"} color={"#00a200"} />
                    <CheckBoxInput textStyle={{...style.black_color_h, fontSize: 17, marginLeft: 10 }} text={"Financing"} color={"#00a200"} />
                    <CheckBoxInput textStyle={{...style.black_color_h, fontSize: 17, marginLeft: 10 }} text={"Other"} color={"#00a200"} />
                </View>
