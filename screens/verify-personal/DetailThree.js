        ...
        <>
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{ ...style.main_heading, textAlign: "left", fontSize: 25, fontFamily: "Poppins-Bold" }}>What would you be {'\n'}using Smart digital bank for?</Text>
                    <Text style={{ ...style.gray_color_f, marginTop: 15, fontSize: 16, fontFamily: "Poppins-Regular" }}>I plan to use Smart Digital Bank for...</Text>
