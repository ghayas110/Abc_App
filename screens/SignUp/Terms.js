  ...
  return (
    ...
    <View style={{
      ...
      <View style={{
          ...
          <Text style={{ ...style.main_heading, textAlign: "left", paddingLeft: 10, fontSize: 25, fontFamily: "Poppins-Bold" }}>  Get more out of your {'\n'}  banking</Text>
          <Text style={{
            fontSize: 17,
            padding: 20,
            color: "#808080",
            fontFamily: "Poppins-Regular"
        }}>We’re committed to protecting your data. Reach out to our customer support team if you have any queries</Text>
        <View style={{
          ...style.basic_container,
        ...
        <Accordion title="Deposit and Transaction Limits">
              ...
              <View style={styles.acordion1}>
              <Text style={styles.text2}>{'\u2022'}</Text>
              <Text style={styles.text2}> Personal Financing-i Declaration and Authorisation</Text>
              </View>
              </Accordion>
              </View>
              <View style={{
              ...
              <View style={styles.acordion}>
                    ...
                    <View style={styles.acordion}>
                          ...
                          <Accordion title="Product Disclosure Sheet">
                                <View style={styles.acordion1}>
                                <Text style={styles.text2}>{'\u2022'}</Text>
                                <Text style={styles.text2}> Commodity Murabahah Savings Account-i Product Disclosure Sheet</Text>
                                </View>
                                <View style={styles.acordion1}>
                                <Text style={styles.text2}>{'\u2022'}</Text>
                                <Text style={styles.text2}> Debit Card-i Product Disclosure Sheet</Text>
                                </View>
                                </Accordion>
                                </View>
                                <View style={{
    ...
    />
        <Text style={{
          ...
          color: "#808080",
          fontFamily: "Poppins-Regular"
      }}>I have read and accepted ALL the documents above. I understand this account is protected by PIDM up to AED 250,000 for each depositor and I have received a copy of the PIDM brochure.</Text>
      </View>
      ...
      <OutlineButton text="Contact Customer Support" onPress={toggleBottomSheet}/>
  ...
  <View style={{ flex: 1, justifyContent: 'flex-end' }}>
      <View style={{ backgroundColor: 'white', padding: 24, borderTopRightRadius: 20, borderTopLeftRadius: 20, }}>
          ...
          <View style={{padding:15}}>
              <Text style={{ ...ThemeSty.gray_color_f, ...ThemeSty.Font_family, fontSize: 16 }}>lease reach out to our 24 hours Customer Support team 1800 81 9149 (local) or +8423242345325 (overseas).
                  Alternatively you may email us at:
                  ssssco.com
                  We’ll get this sorted!</Text>
          </View>
          <View style={{ padding: 20, ...ThemeSty.bg_light_green_color }}>
              <Text style={{ ...ThemeSty.Green_color_f, fontSize: 14, ...ThemeSty.Font_family, fontWeight: '500', }}>Customer Support: +423432534564 (fraud support line 24/7) or email to us at:ssssco.com</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  text2:{
    fontSize: 15, 
    fontWeight:"700",color:'green', fontFamily: "Poppins-Regular"
  },
  text3:{
    fontSize: 16,
    lineHeight:24,
