...
const MainNavigator = ({onLogin}) => {
  return (
    <Stack.Navigator
      ...
      />
      <Stack.Screen
        name="QRAccountSuccess"
        component={QRAccountSuccess}
        screenOptions={{headerShown: false}}
      />
      <Stack.Screen
        name="QRScan"
      ...
      <Stack.Screen
        name="DigitalSecure"
        component={DigitalSecure}
        screenOptions={{headerShown: false}}
      />
      <Stack.Screen
        name="DuetitNowOnWay"
        component={DuetitNowOnWay}
        screenOptions={{headerShown: false}}
      />
      <Stack.Screen
        name="DuetNowSent"
        component={DuetNowSent}
        screenOptions={{headerShown: false}}
      />
      <Stack.Screen
        name="Recipt"
      ...
      <Stack.Screen
        name="AddFundReviewDetails"
        component={AddFundReviewDetails}
      />
      <Stack.Screen
        name="FundSuccessFullyCreated"
        component={FundSuccessFullyCreated}
      />
      <Stack.Screen name="WithdrawFund" component={WithdrawFund} />
      <Stack.Screen name="WithdrawFundReview" component={WithdrawFundReview} />
      <Stack.Screen
        name="WithdrawSuccessfully"
        component={WithdrawSuccessfully}
      />
...
const MoreNavigator = ({onLogin}) => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="UpdateMallingAddress"
        component={UpdateMallingAddress}
      />
